...
input_PBN_matrix = [0.57,    0, 0.1,    0,    0, 0.04,    0,    0; 
                       0, 0.15,   0,    0,    0, 0.08,    0,    0; 
                       0, 0.08, 0.4, 0.25, 0.25,    0, 0.67,    0; 
                       0,    0,   0,    0, 0.38,    0,    0,    0;
                    0.14, 0.31,   0,  0.5, 0.12, 0.13, 0.33, 0.06;
                    0.29, 0.31, 0.2,    0, 0.25, 0.29,    0, 0.39;
                       0, 0.15, 0.3,    0,    0, 0.13,    0,    0;
                       0,    0,   0, 0.25,    0, 0.33,    0, 0.55];
...
stopping_criteria_type = "the_obvious_difference_Ax_minus_b";
